...
%load('exp4_gradient_value_funs_initv2_realWorldSize.mat');
...
h.XLabel = 'w^*'; %'interpreter', 'latex', 'fontsize', 18);
h.YLabel = 'w^0'; %'interpreter', 'latex', 'fontsize', 18);
h.GridVisible = 'off';
colormap plasma
h.Title = 'Minimum TTL True Parameter from Initialization';
