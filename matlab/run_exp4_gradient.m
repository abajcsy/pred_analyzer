...
% --> blocked v2 initial cond. 
all_initial_states = {{2.37, -3.407, 0.1}, ...
                        {2.37, -3.407, 0.25}, ...
                        {2.37, -3.407, 0.5}, ...
                        {2.37, -3.407, 0.75}, ...
                        {2.37, -3.407, 0.9}};
                    
% --> free-space initial cond. 
...
save('exp4_gradient_value_funs_initv2_realWorldSize.mat', 'params', 'all_value_funs', 'all_initial_states');
