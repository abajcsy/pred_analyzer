classdef CarHumanBelief4DFull < handle
    ...
    properties
        ...
        v_range         % (arr) contain min and max velocity [v_min, v_max].
    ...
    methods
        ...
        function znext = physical_dynamics(obj, z, u)
            ...
            elseif u == 2 || u == 3  % FORWARD
                ...
                vel = obj.v_range(mod(u,2) + 1);
                if u == 4 || u == 5 % FORWARD_CW1
                    ang_vel = (2*pi/obj.gnums(3))/obj.dt;
                elseif u == 6 || u == 7 % FORWARD_CCW1
                    ang_vel = -(2*pi/obj.gnums(3))/obj.dt;
                else
        ...
        function [v_grid, q_fun] = compute_q_fun(obj, true_theta_idx, gamma, eps)
            ...
            for i=1:obj.num_ctrls
                ...
                elseif u_i == 4 || u_i == 5 || u_i == 6 || u_i == 7 % FORWARD_CW or FORWARD_CCW
