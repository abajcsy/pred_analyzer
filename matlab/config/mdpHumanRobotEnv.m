function params = mdpHumanRobotEnv()
...
params.uThresh = 0.00; %0.13; % threshold on P(u | x, g) -- e.g. 0.16;0.15;%0.14;%0.13;
...
params.dyn_sys =  MDPHumanRobotBelief(params.initial_state, ...
                                    params.reward_info, ...
                                    params.trueThetaIdx, ...
                                    params.uThresh, ...
                                    gdisc3D, ...
