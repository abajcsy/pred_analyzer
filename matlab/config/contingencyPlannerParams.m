...
pdDim = 3;
params.g3d = createGrid([params.gmin,-pi], [params.gmax, pi], [params.gnums,10], pdDim);
...
params.belief = [0.8, 0.2]; % b(g1) and b(g2)

%% Create spline planner!
params.planner = ContingencyPlanner(params.num_waypts, ...
                params.horizon, ...
                params.goal, ...
