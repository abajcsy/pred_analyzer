...
dyn_sys = MDPHumanBelief2D_Q_K(initial_state, v_inits, trueThetaIdx, uThresh, gdisc, gamma, eps);
...
if plot
    ...
    if plotObstacle
        extraPltArgs.existsObstacle = plotObstacle;
