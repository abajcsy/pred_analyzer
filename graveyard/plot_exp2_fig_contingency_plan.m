...
hsh.Marker = 'o';
hsh.MarkerFaceColor = 'r';
rsh = quiver(r_plan{2}{1}(coll_t_idx), ...
             r_plan{2}{2}(coll_t_idx), ...
             cos(r_plan{2}{5}(coll_t_idx)), ...
             sin(r_plan{2}{5}(coll_t_idx)), 'k', 'filled');
rsh.Marker = 'o';
rsh.MarkerFaceColor = 'k';
...
hrecth = rectangle('position', pos, ...
            'curvature', [1,1], ...
            'EdgeColor', 'r');
pos = [r_plan{2}{1}(coll_t_idx)-robot_params.car_rad, ...
        r_plan{2}{2}(coll_t_idx)-robot_params.car_rad, ...
        robot_params.car_rad*2, robot_params.car_rad*2];
